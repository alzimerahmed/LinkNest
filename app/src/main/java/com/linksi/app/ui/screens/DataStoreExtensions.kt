...
val SECURITY_UNIVERSAL_LOCK = booleanPreferencesKey("security_universal_lock")
val SECURITY_FOLDER_LOCK_ENABLED = booleanPreferencesKey("security_folder_lock_enabled")
